...
const char *const kMsgDClipboardMeta = "DCMT%1i%s";
const char *const kMsgQClipboardData = "QCLD%1i%s";
const char *const kMsgQFileRequest = "QFIL%4i%s";
const char *const kMsgSFileRequest = "SFIL%4i%s";
const char *const kMsgDFileChunk = "DFCH%4i%1i%s";
const char *const kMsgDFileTransferPort = "DFTP%4i%2i";
